...
export const metadata: Metadata = {
  title: "About StoreDesk — Built for C-Store Operations",
  description:
  ...
  openGraph: {
    title: "About StoreDesk | Convenience Store Software",
    description:
    ...
    url: `${siteUrl}/about`,
    images: [{ url: `${siteUrl}/brand/logo-lockup-horizontal.jpg`, width: 1200, height: 400, alt: "About StoreDesk" }]
  }
};
