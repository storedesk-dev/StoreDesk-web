...
export function pageMetadata(input: {
  ...
  // Generated by src/app/opengraph-image.tsx at 1200×630. Named explicitly
  // because a page-level `openGraph` object replaces the parent's wholesale.
  const image = { url: `${SITE_URL}/opengraph-image`, width: 1200, height: 630, alt: "StoreDesk" };
