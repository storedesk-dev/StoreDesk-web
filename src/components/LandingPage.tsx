    ...
    >
      ...
      <div className="space-y-4">
        <div className="mb-2">
          ...
          <h3 className="mt-2 text-2xl font-semibold text-[#17202A] sm:text-3xl">
            {activeScreen.title}
          </h3>
          <p className="mt-1 text-sm font-semibold text-[#1A63F4]">
    ...
    <div className="min-h-screen bg-white text-[#17202A] antialiased selection:bg-[#00A87B] selection:text-white">
      ...
      <section className="sd-hero-wash relative overflow-hidden border-b border-[var(--border)] pb-20 pt-12">
        ...
        <div className="relative mx-auto grid max-w-6xl items-center gap-12 px-6 lg:grid-cols-2 lg:pb-12">
          ...
          <div>
            ...
            <motion.h1
              className="text-balance text-[36px] font-semibold leading-[1.08] tracking-[-0.025em] text-[#17202A] sm:text-[46px] lg:text-[52px]"
            ...
            <motion.div
              className="mt-4 flex h-8 items-center gap-2 text-xs font-bold text-[#00A87B]"
            ...
            >
              <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.96 }}>
                <Link
                  href="/how-it-works"
                  className="inline-flex items-center gap-2 rounded-xl bg-[#1A63F4] px-6 py-3.5 text-sm font-bold text-white shadow-md transition hover:bg-blue-700 hover:shadow-lg"
                >
              ...
              <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.96 }}>
                <a
                  ...
                  className="inline-flex items-center gap-2 rounded-xl border border-slate-300 bg-white px-6 py-3.5 text-sm font-bold text-[#17202A] shadow-sm transition hover:border-[#1A63F4] hover:text-[#1A63F4]"
                >
                  Contact us
                </a>
              </motion.div>
        ...
        <div className="mx-auto grid max-w-6xl md:grid-cols-[32%_68%]">
          ...
          <div className="px-6 pb-8 md:pb-0">
            <div className="sticky top-28">
              ...
              <h2 className="text-3xl font-semibold tracking-tight text-[#17202A] md:text-4xl">What it is for</h2>
          ...
          <div className="space-y-8 px-6 md:border-l md:border-slate-200 md:pl-10">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-xl font-semibold text-[#17202A] sm:text-2xl">See your margin before you reprice</h3>
              </div>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-xl font-semibold text-[#17202A] sm:text-2xl">It only reads from the register</h3>
              </div>
              <p className="mt-4 text-base font-normal leading-relaxed text-slate-700">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-xl font-semibold text-[#17202A] sm:text-2xl">Answers on the shop floor</h3>
              </div>
              <p className="mt-4 text-base font-normal leading-relaxed text-slate-700">
      ...
      <section className="bg-white py-24 overflow-hidden">
        <div className="mx-auto max-w-6xl px-6 text-center">
          <h2 className="text-3xl font-semibold tracking-tight text-[#17202A] md:text-4xl">
      ...
      <section className="border-t border-[var(--border)] bg-[#FBFCFD] py-24">
        <div className="mx-auto max-w-6xl px-6">
          <div>
            ...
            <h2 className="mt-2 text-3xl font-semibold tracking-tight text-[#17202A] md:text-4xl">
